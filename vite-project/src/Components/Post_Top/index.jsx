  ...
  return (
    <div className="divPostTop flex-container">
      <div className="avatarYNombre">
        ...
        <Avatar size="small" className="avatarIcon" icon={user?.profilePicture ? user?.profilePicture : <UserOutlined/>} />
        {/* <p className="title is-6"> Profile Name </p> */}
        <p className="title is-6"> {user?.username ? user.username : "Profile Name"} </p>
      </div>
      <MoreOutlined />
    </div>
  );
